...
You can add external tools to kuucode using the _Model Context Protocol_, or MCP. kuucode supports both:
...
You can define MCP servers in your kuucode config under `mcp`.
