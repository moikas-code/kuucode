...
kuuzuki has a list of keybinds that you can customize through the kuuzuki config.
...
kuuzuki uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
