---
title: Share
description: Share your kuucode conversations.
---

kuucode's share feature allows you to create public links to your kuucode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, kuucode:

1. Creates a unique public URL for your session
2. Syncs your conversation history to our servers
3. Makes the conversation accessible via the shareable link — `kuucode.ai/s/<share-id>`

---

## Sharing

kuucode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, kuucode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `kuucode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using kuucode in your organization.
