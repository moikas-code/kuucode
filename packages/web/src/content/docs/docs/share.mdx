---
title: Share
description: Share your kuuzuki conversations.
---

kuuzuki's share feature allows you to create public links to your kuuzuki conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, kuuzuki:

1. Creates a unique public URL for your session
2. Syncs your conversation history to our servers
3. Makes the conversation accessible via the shareable link — `kuuzuki.ai/s/<share-id>`

---

## Sharing

kuuzuki supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, kuuzuki uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `kuuzuki.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using kuuzuki in your organization.
