    ...
    await App.provide({ cwd: process.cwd() }, async () => {
      ...
      function printNextSteps() {
        ...
        prompts.outro(
          [
            ...
            `    2. ${step2}`,
            "    3. Learn how to use the GitHub agent - https://docs.kuucode.ai/docs/github/getting-started",
          ].join("\n"),
        )
      }
      ...
      async function installGitHubApp() {
        ...
        async function getInstallation() {
          return await fetch(`https://api.kuucode.ai/get_github_app_installation?owner=${app.owner}&repo=${app.repo}`)
            .then((res) => res.json())
